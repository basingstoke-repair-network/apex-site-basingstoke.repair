...
- Repair café locations (currently Chineham and Hatch Warren & Beggarwood, active; Brookvale, coming soon)
...
1. **Chineham Repair Café** (`chineham.json`, active)
   - When: 3rd Saturday of each month, 10:00am–1:00pm (last items 12:30pm)
   - Where: Christ Church Chineham, Reading Road (next to Surgery), RG24 8LT

2. **Hatch Warren & Beggarwood Repair Café** (`hatch-warren.json`, active)
   - When: 1st Saturday of each month, 10:00am–1:00pm (last items 12:30pm)
   - Where: Hatch Warren Community Centre, RG22 4XF

3. **Brookvale Repair Café** (`brookvale.json`, coming soon)
   - Status: no schedule or address yet — planning stage
...
2. Four Lanes Trust
3. Restarters.net
4. Repair Café International
5. Greener Basingstoke
6. National Lottery Community Fund
7. Veolia
8. The Lions Club of Basingstoke
9. Oakley Stitchers CIC
